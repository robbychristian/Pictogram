    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            ...
            <li class="nav-item active">
                    <a class="nav-link navbtn" href="<?php base_url(); ?>home">Home</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link navbtn" href="<?php base_url(); ?>register">Register</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link navbtn" href="<?php base_url(); ?>login">Login</a>
                </li>
            </ul>
        </div>
    </nav>