                        ...
                        <?php foreach ($posts as $post) : ?>
                            <div class="col">
                                <div class="card post-profile" data-toggle="modal" data-target="#id<?php echo $post->id ?>">
                                    <img class="card-img-top" src="<?php echo base_url() ?>assets/post/<?php echo $post->post_img ?>" style="height: 300px; object-fit: contain; min-height: 300px" alt="">
                                </div>
                                <!-- Modal -->
                                <div class="mx-auto">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Post view</h5>
